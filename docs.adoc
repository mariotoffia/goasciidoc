...
CleanTagsProcessor will clean all __ of all
locations where begins a line with the _tag_ directive.


=== CurrentMacroProcessor
[source, go]
----
...
=== TestMulitpleImportWithAliasShallRenderAliasAndImport
[source, go]
----
...
=== TestMulitpleImportWithAliasAndNonAliasShallRenderAliasAndImportOnCorrectPlaces
[source, go]
----
...
=== TestSingleImporShallRenderImport
[source, go]
----
